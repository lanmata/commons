...
class JwtConverterExceptionTest {
    ...
    void defaultConstructorCreatesInstance() {
        JwtConverterException exception = new JwtConverterException();
    ...
    void constructorWithMessageCreatesInstanceWithMessage() {
        ...
        JwtConverterException exception = new JwtConverterException(message);
    ...
    void constructorWithMessageAndCauseCreatesInstanceWithMessageAndCause() {
        ...
        JwtConverterException exception = new JwtConverterException(message, cause);
        assertEquals(message, exception.getMessage());
    ...
    void constructorWithCauseCreatesInstanceWithCause() {
        Throwable cause = new Throwable("Cause");
        JwtConverterException exception = new JwtConverterException(cause);
        assertEquals(cause, exception.getCause());
    }
    ...
    void constructorWithAllParametersCreatesInstanceWithAllParameters() {
        ...
        JwtConverterException exception = new JwtConverterException(message, cause, enableSuppression, writableStackTrace);
        assertEquals(message, exception.getMessage());
        assertEquals(cause, exception.getCause());
