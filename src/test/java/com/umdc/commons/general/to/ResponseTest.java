...
package com.umdc.commons.general.to;
...
class ResponseTest {
    ...
    void testConstructor() {
        ...
        LocalDateTime dateTime = LocalDate.of(1970, Month.JANUARY, 1).atStartOfDay();
    ...
    void testGettersAndSetters() {
        final var localDateTime = LocalDateTime.of(2020, Month.OCTOBER, 29, 21, 31);
