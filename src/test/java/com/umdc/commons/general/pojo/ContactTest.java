...
class ContactTest {
    ...
    void testConstructor() {
        ...
        actualContact.setPersonId(personId);
        actualContact.setApplicationId(applicationId);
        ...
        assertEquals(personId, actualContact.getPersonId());
        assertEquals(applicationId, actualContact.getApplicationId());
    }
