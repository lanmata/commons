...
class UserTest {
    ...
    @Test
    @DisplayName("Set and get email account")
    void setAndGetEmailAccount() {
        User user = new User();
        user.setEmailAccount("test@example.com");
        assertEquals("test@example.com", user.getEmailAccount());
    }

    @Test
    @DisplayName("Set and get display name")
    ...
    @Test
    @DisplayName("Set and get applicationId")
    void setAndGetApplicationId() {
        User user = new User();
        UUID applicationId = UUID.randomUUID();
        user.setApplicationId(applicationId);
        assertEquals(applicationId, user.getApplicationId());
    }
