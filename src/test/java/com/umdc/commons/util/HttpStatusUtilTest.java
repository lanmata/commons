...
class HttpStatusUtilTest {
    ...
    final String unmappedMessage = "Unmapped boundary code should map to DEFAULT_MESSAGE";
    ...
    void unknownCodesReturnDefaultMessage() {
        ...
        assertSame(MessageType.DEFAULT_MESSAGE, HttpStatusUtil.getMessageType(199), unmappedMessage);
        assertSame(MessageType.DEFAULT_MESSAGE, HttpStatusUtil.getMessageType(299), unmappedMessage);
        assertSame(MessageType.DEFAULT_MESSAGE, HttpStatusUtil.getMessageType(399), unmappedMessage);
        assertSame(MessageType.DEFAULT_MESSAGE, HttpStatusUtil.getMessageType(499), unmappedMessage);
    }
