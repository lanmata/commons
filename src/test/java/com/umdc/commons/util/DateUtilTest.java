...
class DateUtilTest {
    ...
    void validateDifferentDates() {
        LocalDate date1 = LocalDate.of(2020, Month.OCTOBER, 23);
        LocalDate date2 = LocalDate.of(2021, Month.OCTOBER, 23);
    ...
    void convertLocalDateTimeToDate() {
        LocalDateTime localDateTime = LocalDateTime.of(2020, Month.OCTOBER, 23, 10, 10, 10);
